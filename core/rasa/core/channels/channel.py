            ...
            if should_use_stream:
                ...
                for msg in collector.messages:
                    ...
                    if bot_response['text']:
                        ...
                        bot_response["hash"] = "12345"
                        print("The hash value for bot response ",hash_object)
                        print("The hash value for bot response ",bot_response)
                    ...
                    if msg.get('custom', None) :#and not response_msg['custom']
                        response_msg['custom'].append(msg.pop('custom'))
