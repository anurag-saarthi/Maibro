...
def get_user_details(tracker):
    ...
    if len(cust_details) > 0:
        ...
        formatted_data["threshold_days"] = 2#config_details["threshold_days"]
        formatted_data["threshold_time"] = "19:00"#config_details["threshold_time"]
