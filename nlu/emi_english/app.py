...
# list_of_signals_to_intent = ["language_change","emi_amount","credit_limit","customer_contact_number","client_name","talk_to_human_agent","eligibility",
#     "login","processing_time","agreement","who_are_you","credit_limit","tenure",
#     "alternative_contact_number","registration","documents_required","method","credit_score","charges","processing_fees","interest_rate"]
...
def webhook():
    ...
    if str(msg).lower() == "hello" or str(msg).lower() == "hey":
        ...
        if "<nlu_data>" not in msg:
            ...
            language = intent_response['lang'][0]['name']
            try:
                ...
                entity_response = requests.post('https://stage-fullertonner.saarthi.ai/predict',json={"text": str(msg),"lang":language}).json()
                print("444",entity_response)
...
if __name__ == '__main__':
    app.run(debug = False,port=13522)
