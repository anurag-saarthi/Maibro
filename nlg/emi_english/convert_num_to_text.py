...
# Object for Symbol parser
sp = SymbolParser()
async def convert_numbers(number,language):
    print("number in file ",number)
    print("language",language)

    # print(sp.parseSymbols(number,language))
    # print("Delay ---> ",datetime.datetime.now()-start_time)
    return sp.parseSymbols(number,language)

# def convert_numbers_new(number,language):
#     print("number in file ",number)
#     print("language",language)
#     sp = SymbolParser()
#     return sp.parseSymbols(number,language)
...
# print(convert_numbers("5000","english"))
...
# number = 13000
# language = "gujarati"
# a = convert_numbers_new(str(number),language.lower()) 
# print(a)